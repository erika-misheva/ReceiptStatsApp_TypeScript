export function format(products) {
    ...
    products.forEach(product => {
        ...
        descriptionParagraph.innerHTML = `${product.description
            ? `<p>&nbsp;&nbsp;&nbsp;&nbsp;Description: ${product.description.slice(0, 10)}...</p>`
            : ""}; `;
        output.appendChild(descriptionParagraph);
        const weightParagraph = document.createElement('p');
        weightParagraph.innerHTML = `&nbsp;&nbsp;&nbsp;&nbsp;Weight: ${product.weight !== undefined ? product.weight + "g" : "N/A"}`;
